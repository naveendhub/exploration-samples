...
WORKDIR /src
COPY ["AWSServerlessDemo.csproj", "AWSServerlessDemo/"]
RUN dotnet restore "AWSServerlessDemo/AWSServerlessDemo.csproj"

WORKDIR "/src/AWSServerlessDemo"
COPY . .
RUN dotnet build "AWSServerlessDemo.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AWSServerlessDemo.csproj" \
